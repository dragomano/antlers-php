...
Standalone implementation of the [Antlers](https://statamic.dev/frontend/antlers) template engine, designed as an alternative implementation for use **outside the Statamic/Laravel ecosystem** in any PHP 8.2+ project.
